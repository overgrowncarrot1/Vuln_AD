...
setspn -A maraudersec.local/mssql_service:1433 maraudersec.local\mssql_service
Set-ADUser -Identity "bob.builder" -PasswordNeverExpires $false -ChangePasswordAtLogon $true
Set-ADUser -Identity "charlie.brown" -PasswordNeverExpires $false -ChangePasswordAtLogon $true  
